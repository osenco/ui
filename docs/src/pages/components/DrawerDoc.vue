<template>
  <div>
    ...
    <Box :code="exampleCode" title="Drawer">
      ...
      <primary-btn type="primary" @click="drawerLeftVisible = true"
        >Left drawer</primary-btn
      >
      <primary-btn type="primary" @click="drawerVisible = true"
        >Right drawer</primary-btn
      >
      ...
      <it-drawer v-model="drawerVisible">
        ...
        <template v-for="(user, i) in fakeUsers" :key="i">
          <div class="flex flex-row px-6 justify-between">
            ...
            <primary-btn icon="call" type="primary"></primary-btn>
          </div>
          <it-divider />
        </template>
      </it-drawer>
...
export default defineComponent({
  data: () => ({
    ...
    fakeUsers: [],
    exampleCode: `<primary-btn @click="drawerLeftVisible = true" type="primary">
    Left drawer
    </primary-btn>

<primary-btn @click="drawerVisible = true" type="primary">
  Right drawer
</primary-btn>
